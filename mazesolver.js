...
function Nextpage()
{
    if(pno == 1)
    {
        pageNo.innerHTML = '2/3';
        pno = 2;
    }
    else if(pno == 2)
    {
        pageNo.innerHTML = '3/3';
        pno = 3;
    }
    else if(pno == 3){
        pageNo.innerHTML = '1/3';
        pno = 1;
    }
...
function content()
{
    ...
    {
        pageContent.innerHTML = '<br><img src="maze_dwn.jpeg"><br><h4>You can now Download the maze after solving it!!<br>Also you can move around this Insturction Panel</h4>'
    }
    else if(pno == 3)
    {
